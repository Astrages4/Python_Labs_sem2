...
# Постановка задачи: 
Разработать очередь задач ( TaskQueue ), поддерживающую итерацию, фильтрацию и потоковую обработку задач.
...
# Ожидаемый результат: 
Коллекция задач, совместимая со стандартными конструкциями Python ( for , list , sum ).
